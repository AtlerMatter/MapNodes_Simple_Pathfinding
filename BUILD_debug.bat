...
:Compile
cl.exe /ZI /W4 /EHsc /MTd /Od /RTC1 /MP /fp:precise /sdl /Iinclude /Isrc\\vendor /Fedebug\\%CurrDir%_debug.exe /Fodebug\\ /Fddebug\\ %file% /link /MACHINE:X64 lib\\*.lib gdi32.lib user32.lib kernel32.lib shell32.lib
